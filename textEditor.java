        ...
        if(s.equals("cut"))t.cut();
            ...
            if(r==JFileChooser.APPROVE_OPTION){
                ...
                try{
                    ...
                    while((s1=br.readLine())!=null)sl+="\n"+s1;

                    t.setText(sl);
                }catch(Exception evt){
                    JOptionPane.showMessageDialog(f,evt.getMessage());
                }
            }else JOptionPane.showMessageDialog(f,"the user cancelled the operatoin");
        }else if(s.equals("New"))t.setText("");
